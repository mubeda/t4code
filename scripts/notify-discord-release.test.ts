...
it("builds a prerelease Discord announcement for nightly subscribers", () => {
  assert.deepStrictEqual(
    buildDiscordReleaseAnnouncement({
      ...
      releaseName: "T4Code Nightly 1.2.4-nightly.20260501.17 (abcdef123456)",
    ...
    {
      content:
        "<@&111111111111111111> Prerelease published: T4Code Nightly 1.2.4-nightly.20260501.17 (abcdef123456)",
      allowed_mentions: {
...
it("builds a latest Discord announcement for stable subscribers", () => {
  assert.deepStrictEqual(buildDiscordReleaseAnnouncement(latestAnnouncement), {
    content: "<@&222222222222222222> Latest published: T4Code v1.2.3",
    allowed_mentions: {

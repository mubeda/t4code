  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new T4Code prerelease is available for nightly testers."
          : "A new T4Code latest release is available.",
...
).pipe(Command.withDescription("Post a T4Code release announcement to Discord."));

...
>()("@t4code/contracts/environmentHttp/EnvironmentAuthenticatedPrincipal") {}
...
export class EnvironmentMetadataHttpApi extends HttpApiGroup.make("metadata").add(
  HttpApiEndpoint.get("descriptor", "/.well-known/t4code/environment", {
...
export class EnvironmentConnectHttpApi extends HttpApiGroup.make("connect")
  ...
  .add(
    HttpApiEndpoint.post("health", "/api/t4code-connect/health", {
  ...
  .add(
    HttpApiEndpoint.post("t4codeMintCredential", "/api/t4code-connect/mint-credential", {
      payload: RelayCloudMintCredentialRequest,
      success: RelayEnvironmentMintResponse,
      error: EnvironmentHttpCloudErrors,
    }),

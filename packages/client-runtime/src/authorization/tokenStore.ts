...
import { RelayManagedEndpoint } from "@t4code/contracts/relay";
...
export class RemoteDpopAccessToken extends Schema.Class<RemoteDpopAccessToken>(
  "@t4code/client-runtime/authorization/RemoteDpopAccessToken",
)({
...
>()("@t4code/client-runtime/authorization/tokenStore/RemoteDpopAccessTokenStore") {}

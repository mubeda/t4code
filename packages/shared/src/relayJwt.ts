...
export const RELAY_LINK_PROOF_TYP = "t4code-env-link+jwt";
export const RELAY_MINT_REQUEST_TYP = "t4code-cloud-mint+jwt";
export const RELAY_HEALTH_REQUEST_TYP = "t4code-cloud-health+jwt";
export const RELAY_MINT_RESPONSE_TYP = "t4code-env-mint+jwt";
export const RELAY_HEALTH_RESPONSE_TYP = "t4code-env-health+jwt";
export const RELAY_ACTIVITY_PUBLISH_TYP = "t4code-env-activity+jwt";

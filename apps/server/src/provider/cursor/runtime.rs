...
impl CursorSessionRuntime {
    ...
    pub async fn start(&self) -> Result<(), CursorRuntimeError> {
        ...
        *self.inner.provider_session_id.lock().await = session_id;
    ...
    pub async fn respond_to_request(
        ...
        let result = match pending.kind {
            ...
            PendingRequestKind::UserInput => json!({ "outcome": "cancelled" }),
        };
        self.inner
            .connection
            .lock()

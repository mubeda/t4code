...
const ROUTER_HOST = "app.t4code.codes";
const HOSTED_WEB_CHANNEL_COOKIE = "t4code_web_channel";
const LATEST_ORIGIN = "https://latest.app.t4code.codes";
const NIGHTLY_ORIGIN = "https://nightly.app.t4code.codes";
...
export const config: VercelConfig = {
  buildCommand:
    'vp run --filter @t4code/web build && node ../../scripts/apply-web-brand-assets.ts --channel "${VITE_HOSTED_APP_CHANNEL:-latest}"',
  git: {
    deploymentEnabled: false,
  },
  installCommand:
    "npm install -g vite-plus && vp install --filter '@t4code/scripts...' --filter '@t4code/web...'",
  routes: [
    {
      src: "/__t4code/channel",

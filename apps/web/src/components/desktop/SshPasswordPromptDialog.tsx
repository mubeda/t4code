    ...
    >
      <DialogPopup className="max-w-md" showCloseButton={false}>
        <DialogHeader>
          ...
          <DialogDescription>
            T4 needs your SSH password to connect to <code>{target}</code>. The password is passed
            to the local SSH process for this connection attempt and is not saved by T4Code.
          </DialogDescription>
        </DialogHeader>

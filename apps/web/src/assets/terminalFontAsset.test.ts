...
describe("bundled terminal Nerd Font asset", () => {
  it("contains Powerline, Nerd private-use, and supplementary-plane glyphs", () => {
    const parsed = create(
      NodeFS.readFileSync(new URL("SymbolsNerdFontMono-Regular.woff2", assetDirectory)),
    );
  ...
  it("records pinned provenance and includes the upstream license", () => {
    ...
    expect(source).toContain("8efa6ba89f0a1f3eefde028f36aa64a13e36282e15ea0ca6929c664501037467");

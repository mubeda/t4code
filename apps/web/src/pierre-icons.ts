...
const PIERRE_ICON_SPRITE_ID = "t4code-pierre-file-icon-sprite";

const T4CODE_FILE_ICON_SPRITE = `
<svg xmlns="http://www.w3.org/2000/svg" width="0" height="0" aria-hidden="true">
  <symbol id="t4code-file-icon-package-json" viewBox="0 0 32 32">
    <path d="M2 2H30V30H2" fill="#c12127" />
    <path d="M7.25 7.25h17.5v17.5h-3.5v-14H16v14H7.25" fill="#fff" />
  </symbol>
  <symbol id="t4code-file-icon-tsconfig" viewBox="0 0 32 32">
  ...
  <symbol id="t4code-file-icon-agents" viewBox="0 0 32 32">
  ...
  <symbol id="t4code-file-icon-claude" viewBox="0 0 32 32">
  ...
  <symbol id="t4code-file-icon-readme" viewBox="0 0 32 32">
  ...
  <symbol id="t4code-file-icon-pnpm" viewBox="0 0 32 32">
...
export const T4CODE_PIERRE_ICONS = {
  set: "complete",
  colored: true,
  spriteSheet: T4CODE_FILE_ICON_SPRITE,
  byFileName: {
    "package.json": "t4code-file-icon-package-json",
    "tsconfig.json": "t4code-file-icon-tsconfig",
    "agents.md": "t4code-file-icon-agents",
    "claude.md": "t4code-file-icon-claude",
    "readme.md": "t4code-file-icon-readme",
    "pnpm-lock.yaml": "t4code-file-icon-pnpm",
    "pnpm-workspace.yaml": "t4code-file-icon-pnpm",
  },
} satisfies FileTreeIcons;

const completeIconResolver = createFileTreeIconResolver(T4CODE_PIERRE_ICONS);
...
export function ensurePierreIconSprite(): void {
  ...
  container.innerHTML = `${getBuiltInSpriteSheet("complete")}${T4CODE_FILE_ICON_SPRITE}`;
